...
face_analyst_model_checkpoint_name = settings.FACE_ANALYST_MODEL_CHECKPOINT_PATH_NAME
face_analyst_model_name = settings.FACE_ANALYST_MODEL_NAME
emotion_checkpoint_name = settings.EMOTION_CHECKPOINT_PATH_NAME
emotion_model_name = settings.EMOTION_MODEL_NAME
age_checkpoint_name = settings.AGE_CHECKPOINT_PATH_NAME
age_model_name = settings.AGE_MODEL_NAME
gender_checkpoint_name = settings.GENDER_CHECKPOINT_PATH_NAME
gender_model_name = settings.GENDER_MODEL_NAME
race_checkpoint_name = settings.RACE_CHECKPOINT_PATH_NAME
